...
//    },
    ...
    **/
    createui: function()
    {
        ...
        $("<div>", { 'class': "iviewer_zoom_in iviewer_common iviewer_button btnn", 'title': "Zoom In" })
					.append('<i class="icon-white icon-plus"> </i>')
                    .bind('mousedown touchstart',function(){me.zoom_by(1); return false;})
                    .appendTo(this.container);

        $("<div>", { 'class': "iviewer_zoom_out iviewer_common iviewer_button btnn", 'title': "Zoom Out" })
					.append('<i class="icon-white icon-minus"> </i>')
                    .bind('mousedown touchstart',function(){me.zoom_by(- 1); return false;})
                    .appendTo(this.container);

        $("<div>", { 'class': "iviewer_zoom_fit iviewer_common iviewer_button btnn", 'title': "Smart Fit" })
					.append('<i class="icon-white icon-fullscreen"> </i>')
                    .bind('mousedown touchstart',function(){me.fit(this); return false;})
                    .appendTo(this.container);

//        $("<div>", { 'class': "iviewer_zoom_zero iviewer_common iviewer_button btnn", 'title': "Zoom 0" })
...
//                                    .appendTo(this.container);
        ...
        $("<div>", { 'class': "iviewer_rotate_left iviewer_common iviewer_button btnn", 'title': "Rotate" })
					.append('<i class="icon-white icon-repeat"> </i>')
